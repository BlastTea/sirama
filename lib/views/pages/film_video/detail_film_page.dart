...
class DetailsFilmPage extends StatefulWidget {
  ...
  @override
  State<DetailsFilmPage> createState() =>
      DetailsFilmPageState();
}

class DetailsFilmPageState
    extends State<DetailsFilmPage> {
        ...
        body: SafeArea(
          ...
          Padding(
              ...
              child: ListView.builder(
                itemCount: dataDummyFilm.length,
                shrinkWrap: true,
                physics: const NeverScrollableScrollPhysics(),
                itemBuilder: (context, index) => InkWell(
                  onTap: () {
                    // Navigate to the detail page and pass the necessary dataDummyFilm
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => DetailsFilmPage(
                          videoUrl: dataDummyFilm[index]['link_film']!,
                          title: dataDummyFilm[index]['judul_film']!,
                          uploadUserId: dataDummyFilm[index]['creator']!,
                          totalLike: dataDummyFilm[index]['like']!,
                        ),
                      ),
                    );
                  },
                    ...
                    children: <Widget>[
                      ...
                      ListTile(
                        ...
                        leading: CircleAvatar(
                          backgroundImage: NetworkImage(dataDummyFilm[index]['profile_url']!),
                        ),
                        title: Text(
                          dataDummyFilm[index]['judul_film']!,
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                        subtitle: Text(
                          "${dataDummyFilm[index]['creator']!} . ${dataDummyFilm[index]['date']!}",
